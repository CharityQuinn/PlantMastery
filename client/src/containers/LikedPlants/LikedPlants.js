      ...
      <div className="row" style={{ margin: "0" }}>
        {this.state.likedList.length ? this.state.likedList.map(plant => (
          <Flippy
            flipOnHover={false}
            flipOnClick={true}
            flipDirection="horizontal" ref={(r) =>  this.flippy = r} style={{height: '245px', width:'320px', position: 'relative', boxShadow: '10px 5px 20px'}}> 
              <FrontSide>
                <div className="col-12 col-sm-12 col-md-4 col-lg-3 plantCard mt-4" key={plant._id}>
                  <div className="card">
                    <img src={plant.image} id="plantImg" alt={plant.name} />
                ...
                <div className="col-12 col-sm-12 col-md-4 col-lg-3 plantCard mt-4" key={plant._id}>
                  <div className="card">
                    ...
                    <div className="btn-group" role="group" aria-label="Basic example" >
                      ...
                      <button type="button" className="btn btn-secondary" id="BtnDisLike" onClick={() => this.handleDislike(plant.name)}>Dislike Plant</button>
                    </div>
                  </div>
                </div>
              </BackSide>
